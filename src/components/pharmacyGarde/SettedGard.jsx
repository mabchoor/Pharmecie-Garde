...
export default function SettedGard(pharmacy) {
    ...
    return (
        <div className="mb-4 relative" style={{ "width": "500px " }} >
            < div
                className="flex justify-center rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700 md:max-w-xl md:flex-row" >
                <img
            ...
            <button
                className={`absolute top-0 right-0 mt-2 p-2 bg-green-500 rounded-lg text-white hover:bg-gray-500`}
